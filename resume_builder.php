  ...
  <div class="w3-row-padding">
      ...
      <div class="w3-white w3-text-grey w3-card-4"  >
        <div class="w3-display-container">
          <div class="img-container">
            <img src="./img/job1.jpg" style="width:100%; height:400px; " alt="Avatar">
          </div>
        ...
        <div class="w3-container">
          ...
          <p><i class="fa fa-street-view fa-fw w3-margin-right w3-large w3-text-teal"></i>C, C++, .Net, NodeJS, ReactJS, MySQL</p>
          ...
          <p><i class="fa fa-language fa-fw w3-margin-right w3-large w3-text-teal"></i>English, Spanish, Japanese</p>
    ...
    <div class="w3-twothird">
     ...
     <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          <h5 class="w3-opacity"><b>Young dynamic engineer with 2 years experience in software industry as well as experience in product management.</b></h5>
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          <h5 class="w3-opacity"><b>2 years experience as Software Developer as well as product manager</b></h5>
          <!-- <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>Jan 2015 - <span class="w3-tag w3-teal w3-round">Current</span></h6>
          <p></p>
          <hr>
        </div>
