...
<section class="form" style="margin-left: 0px; background-image: url(img/background.jpg);width: 100%; height: auto; background-repeat: no-repeat; background-size: cover; background-attachment: fixed;">
   ...
   <div class="row">
    <div class="col-25">
      <label for="name"><h3 style="color: white;">Basic Job Ads</h3></label>
...
<div class="row">
  ...
  <div class="row">
    <div class="col-75">
      ...
      <div class="col-75">
         <textarea id="name" type="textarea" required="" name="description" placeholder="description" ></textarea>
      </div>
    </div>
  </div>
  <br>
  <div class="row">
    <div class="col-75">
      ...
      <div class="col-75">
         <textarea type="textarea" id="requirement" required=""name="requirement" placeholder="requirement"></textarea>
      </div>
    </div>
  </div>
<br>
  <div class="row">
    <div class="col-25">
      ...
      <div class="col-75">
         <textarea type="textarea" id="skill" required="" name="skill" placeholder="skills"></textarea>
      </div>
    </div>
  </div>
  <br>
